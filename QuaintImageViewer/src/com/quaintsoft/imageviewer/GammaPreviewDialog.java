...
public class GammaPreviewDialog extends PreviewDialog
	...
	public GammaPreviewDialog(Context context, OnGammaSetListener callBack) {
		super(context);
	...
	@Override
	protected void setupOtherViews() {
		setupGammaSeekBar();
		setupResetButton();
	}
